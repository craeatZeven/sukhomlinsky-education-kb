...
| 苏霍姆林斯基选集（五卷本）第2卷（`xuan-ji-zh-vol2`） | 104 | 45/104 |
| 苏霍姆林斯基选集（五卷本）第3卷（`xuan-ji-zh-vol3`） | 84 | 51/84 |
| 苏霍姆林斯基选集（五卷本）第4卷（`xuan-ji-zh-vol4`） | 71 | 41/71 |
| 苏霍姆林斯基选集（五卷本）第1卷（`xuan-ji-zh-vol1`） | 63 | 36/63 |
...
| 主题 | 卡片数 |
|---|---:|
| 爱的教育（`love-education`） | 420 |
| 儿童研究（`child-study`） | 338 |
| 家校合作（`family-school`） | 249 |
| 美育与自然（`aesthetic-nature-education`） | 249 |
| 集体教育（`collective-education`） | 216 |
| 劳动教育（`labor-education`） | 189 |
| 教师成长（`teacher-growth`） | 177 |
| 思维课与大自然（`thinking-and-nature`） | 149 |
| 学习困难学生（`learning-difficulties`） | 91 |
