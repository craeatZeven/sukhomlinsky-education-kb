...
def main() -> int:
    ...
    lines.append('- 五卷本已按作品统计（`docs/coverage-volumes.md`），并完成章节级覆盖审计（`docs/coverage-volumes-chapters.md`）与两轮剩余缺口审计（`docs/coverage-volumes-gaps-remaining.md`、`...-round2.md`）：原 143 个 gap 中 95 个已不再空白、47 个仍空白、1 个口径存疑。')
