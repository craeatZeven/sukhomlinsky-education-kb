...
|---|---|---|---|---|
| 苏霍姆林斯基选集（五卷本）第1卷 | 教育科学出版社，中文扫描 OCR | `ocr/mineru-range/merged/苏霍姆林斯基选集（五卷本）第1卷.txt` | 1.39 MB | 67 |
| 苏霍姆林斯基选集(五卷本)第2卷 | 同上 | `.../第2卷.txt` | 1.40 MB | 287 |
| 苏霍姆林斯基选集（五卷本）第3卷 | 同上 | `.../第3卷.txt` | 1.59 MB | 97 |
| 苏霍姆林斯基选集(五卷本)第4卷 | 同上 | `.../第4卷.txt` | 1.46 MB | 77 |
| 苏霍姆林斯基选集（五卷本）第5卷 | 同上（68篇论文集） | `.../第5卷.txt` | 1.43 MB | 167 |
| 给教师的建议 | 杜殿坤编译，教育科学 | `.../苏霍姆林斯基-给教师的建议.txt` | 1.02 MB | 24 |
| 做人的故事 | 诸惠芳等译，人民教育 2015，读秀图像 OCR | `zuoren-gushi-full-ocr.md` / `zuoren-gushi-ocr-pages.jsonl` | 443页 / 24.2万字 | 541（541/541 篇已建卡，含同题两篇） |
...
- 卡片总数：1386（13 sources / 12 topics）
- 核心著作：五卷本 + 给教师的建议 + 做人的故事 已形成可检索中文全文池
- 《做人的故事》：目录共 541 篇（540 个不重复标题 + 同题《暴风雪》两篇：p59 救小鸟 / p277–278 托利亚与萨沙）已全部建卡（含 OCR 异题/异体字按正文校订；507「狼良的牙齿」按正文题名「狼的牙齿」建卡；323「会唱歌的羽毛」另有 ZuoRen 中文原版卡 sk-0982）；漏卡根因（目录标题去重）与全量审计见 `docs/zuoren-uncarded-audit.md`
...
4. 五卷本：`docs/coverage-volumes-chapters.md` 的 143 个 `gap` 已全部补卡（第 1/3/4/5 卷连续三轮清零，第 2 卷由 sk-1232–sk-1238 补齐）；下一步转「加密度」——第 2 卷 166 个审计单位仅 2 个 ≥3 张卡，优先给教师高频篇目补第 2–3 张卡；
