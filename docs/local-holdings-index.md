...
- 卡片总数：1069（13 sources / 12 topics）
...
- 113条官方故事书目：已盘点，并完成“条目↔卡片”对照草稿：93/113 高置信可挂现有卡（两轮共 40 条抽样复核，修正 3 条；见 `docs/coverage-official-tales.md`、`docs/coverage-official-tales-mapping.md` 及两份 verification 报告）
