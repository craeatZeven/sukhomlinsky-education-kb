...
- [x] 可溯源卡片 **1386 张**（13 个来源）
- [x] 《做人的故事》目录 **541 篇全部建卡**（540 个不重复标题 + 同题《暴风雪》两篇），页码已与 OCR 正文页逐条核对
- [x] 覆盖审计：44 篇《美德故事》44/44 盘点、113 条官方故事书目 + 99 条卡片对照（全量核验）、五卷本按作品与章节级覆盖
- [x] 五卷本章节级审计：310 个审计单位（13 covered / 154 partial / 143 gap）；四轮补卡后原 143 个 gap 中 135 个已不再空白、7 个仍空白、1 个存疑（第四轮快照），随后由 sk-1232–sk-1238 补齐该 7 项，见 `docs/coverage-volumes-gaps-remaining-round4.md`
...
| [`tools/web-audit/`](tools/web-audit/README.md) | **浏览器回归验证**：24 条行为/数据/对比度判据 + 三主题 × 七页对比度普查（要真实 Chrome，不进离线链） |
