...
def main() -> int:
    ...
    lines.append('- 五卷本已按作品统计（`docs/coverage-volumes.md`），并完成章节级覆盖审计与三轮剩余缺口审计：原 143 个 gap 中 115 个已不再空白、27 个仍空白、1 个口径存疑；详见 `docs/coverage-volumes-chapters.md` 与 `docs/coverage-volumes-gaps-remaining-round3.md`。')
